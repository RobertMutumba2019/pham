...
$(document).ready(function(){
	...
	$('#loginBtn').click(function(){
		...
		if(username=="" || password==""){
			...
			$('#loginStatus').html('<img src="'+urlPath+'images/loading.gif" alt="loading..."/>');
			$(this).html("Checking Credentials");
			$(this).attr("disabled", true);
			var form_data = new FormData();
			...
			success: function(data){
				...
				if (values.message=='Error') {
					...
					$('#loginBtn').attr('disabled',false);
					$('#loginStatus').html('Wrong Username or Password');
				}else{
					location.reload();
...
$('#AccsettingBtn').off('click').on('click',function(e){
	...
	if(!confirm('Are you sure you want to change password?')){
		...
		if(email_password==""){
			errors.push("Please Old Password");
		}
		if(password==""){
